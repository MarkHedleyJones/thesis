...
\section{Double Layers}
  ...
  \subsection{Formation}
    ...
    \Cref{fig:butterfat} shows the structure of a butterfat molecule.
  ...
  \subsection{A physical model}
    ...
    % Edit checkpoint 2015-09-09 21:06
    ...
    % Edit checkpoint 2015-09-10 19:37
  ...
  \subsection{Structure}
    ...
    \end{figure}
    \Cref{fig:doubleLayer_anatomy} shows double layer organisation according to the currently accepted Goüy-Chapmam-Stern model.
...
\section{Streaming Cells}
  ...
  % Double layers on flat surfaces
  \begin{figure}
      \centering
  ...
  % Edit checkpoint 2015-09-09 20:14
  ...
  % Edit checkpoint 2015-09-09 20:35
  ...
  \subsection{Literature review}
    ...
    % Edit checkpoint 2015-09-09 21:00
    ...
    \Cref{fig:width_height_length} shows the meaning of `width', `height', and `length' when referring to streaming cells or micro-channels in this thesis.
    ...
    %   \caption[Diagram showing hydrodynamic slip inside a channel cavity.]{\label{fig:HydrodynamicSlip}Diagram showing hydrodynamic slip inside a channel cavity, where $b$ is the slip length. Arrows indicate flow velocity at particular points.}
    % \end{figure}

    % \begin{figure}
    %   \begin{subfigure}{0.3\textwidth}
    %     \centering
    %     \includegraphics[height=6cm]{content/background/graphics/HydrodynamicSlip_negativeLength}
    %     \caption[Diagram showing hydrodynamic slip inside a channel cavity.]{\label{fig:HydrodynamicSlip_negative}Negative slip}
    %   \end{subfigure}
    %   \begin{subfigure}{0.3\textwidth}
    %     \centering
    %     \includegraphics[height=6cm]{content/background/graphics/HydrodynamicSlip_negativeLength}
    %     \caption[Diagram showing hydrodynamic slip inside a channel cavity.]{\label{fig:HydrodynamicSlip_zero}No slip}
    %   \end{subfigure}
    %   \begin{subfigure}{0.3\textwidth}
    %     \centering
    %     \includegraphics[height=6cm]{content/background/graphics/HydrodynamicSlip_negativeLength}
    %     \caption[Diagram showing hydrodynamic slip inside a channel cavity.]{\label{fig:HydrodynamicSlip_positive}Positive slip}
    %   \end{subfigure}
    %   \caption{Plots}
    %   \label{fig:HydrodynamicSlip}
    % \end{figure}
    ...
    \Cref{fig:HydrodynamicSlip_zero} illustrates a typical `no-slip boundary condition' where the fluid at the solid/fluid boundary is static.
    ...
    %They provide a more conservative prediction of \SI{40}{\percent} for slip lengths in the tens of nanometres region and low salt concentration.
    ...
    % Edit checkpoint 2015-09-09 21:24
...
\section{Impedance Modelling}
  ...
  \Cref{part:doubleLayersOnConductors} studies the impedance of an interface between an electrolyte and an electrode.
  ...
  % \frac{d}{dx}x = 1
  % \end{equation}
  % when the differentiation operation is only half applied results in \cite{Torokhti1974}:
  % \begin{equation}
  % \frac{d^{1/2}}{dx^{1/2}}x = \frac{2\sqrt{x}}{\sqrt{\pi}}
  % \end{equation}
  ...
  % Circuit simulators rely on knowing the impedance of components to calculate the currents and voltages in circuit branches.
  ...
  \Cref{part:doubleLayersOnConductors} of this thesis uses a model of an electrode-electrolyte interface to solve this problem for implant designers.
  ...
  % Edit checkpoint 2015-09-12 11:00
  ...
  \Cref{part:doubleLayersOnConductors} of this thesis looks at ways of doing that using a model of the interface based on electronic components.
  ...
  \subsection{Literature review}
    ...
    In 1899, Warburg presented his interpretation of the impedance between electrodes in an electrolyte~\cite{Warburg1899}.
    ...
    Overall, the trend in electrode interface publications appears to be a gradual refinement of the initial model put forward by Warburg in 1899.
