...
\section{Streaming Cells}
  ...
  \subsection{Literature review}
    ...
    \begin{enumerate}
      ...
      \item found that the maximum conversion efficiency corresponded to channels where double layers begin to overlap; confirming the relationship put forward by Daiguji et al.\
