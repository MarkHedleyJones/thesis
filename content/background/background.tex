...
\section{Impedance Modelling}
  ...
  This is an important question to the designers of medical implant devices.
  ...
  The problem they faced is predicting the electrical impedance that their implant will see once implanted.
  ...
  In \cref{sect:background_doubleLayers}, illustrations of double layers were presented that showed how the interface is comprised of layers.
  A more realistic illustration of a double layer is shown in \cref{fig:interface}.
  This version shows some interactions between polar molecules and themselves
