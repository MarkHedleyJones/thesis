...
\subsection{\label{sub:Experimental-Procedure}Experimental procedure}
  ...
  \subsubsection*{Construction}
    ...
    Once set, the plastic shims were cut to the required size, covered with a very thin layer of epoxy, and placed along the edges of the slide.
    ...
    Once set, the channel was then photographed under microscope to determine the true internal height of the channel.
    Each of the four corner heights were measured to ensure that the channel remained rectangular once fixed in place.
    
    Finally, acrylic reservoirs where mounted over each end of the channel.
  ...
  \subsubsection*{Measurement}
    ...
    Measurement of the harvester's output power was conducted using precision source measurement units (SMU).
    ...
    The device was controlled using Python scripts utilising the open source Python-vxi11 library~\cite{Python-ivi2014}.
    This allows sweeping the amount of current drawn from the harvester while recording the corresponding voltage drop.
    Doing this essentially gives us the ability to vary the load resistance across the harvester so we can find the point of maximum power transfer.
