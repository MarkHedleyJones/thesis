...
A \SI{2e-9} conversion efficiency from water flow and pressure was demonstrated.
...
\section{Trends in Water Metering}
  ...
  For residents of Wellington, New Zealand's capital city, water metering is optional.
  In metered locations, meter readers must manually read the display of each meter, which is a long and laborious task.
  ...
  \section{Mechanical Design of a Harvester}
    ...
    the channel can be widened (doubling the width will double the output power), or multiple channels can be stacked together (this multiplies the output by the number of channels formed).
  ...
  \label{sect:part1-WirelessWaterMeter-QuantifyingHarvestableEnergy}
    ...
    The efficiency of converting energy into the electrical domain was measured in~\cref{chap:part1_streamingCellHarvesters} and was found to be \SI{2e-9}.
    ...
    The efficiency measured in~\cref{chap:part1_streamingCellHarvesters} was lower than others had suggested.
