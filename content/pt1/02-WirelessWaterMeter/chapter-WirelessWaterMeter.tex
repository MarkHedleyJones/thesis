...
%        \caption{Profile of power dissipation within a mechanical water meter over a week for a two occupant dwelling.}
%        \label{fig:powerDissipationProfile}
%    \end{figure}
    ...
    This profile is shown as~\cref{fig:powerDissipationProfile}.
    ...
    \Cref{tab:energy_dissipation_total_figures} aggregates energy dissipation for each event type over the constructed profile.
    ...
    Ignoring washing machine use, indicative of weekday consumption, the quantity of harvestable energy is expected to be about \SI{280}{\joules} per day.

    Knowing the quantity of energy available to a harvester is a key factor determining its feasibility.
    The efficiency of converting energy into the electrical domain was measured in~\cref{chap:powerHarvesting} at \SI{0.2}{\micro\percent}.
    ...
    The literature indicates the efficiency measured in~\cref{chap:powerHarvesting} was low.
