...
% as raw data, can be found in appendix %\ref{Appendix:Measurements} .
  ...
  \subsection{Power consumption benchmarks}
    ...
    \subsubsection*{Sleeping}
      ...
      \cref{fig:All_Sleep_Current} shows the amount of current consumed by each MCUs while in their deepest sleep state.
      It can be seen that the PIC16F1827 consumes the most current.
      This is somewhat contradictory to its specified sleep current of 30nA \cite{PIC16F1827} (the second lowest of the set) at almost 1000 times higher.
      The Freescale MC9S08QG8 consumed energy at an average
