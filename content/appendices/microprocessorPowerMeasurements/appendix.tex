...
\begin{figure}
\begin{centering}
\includegraphics{content/appendices/microprocessorPowerMeasurements/Graphs/Graph_All_Sleeping_Power}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics{content/appendices/microprocessorPowerMeasurements/Graphs/Graph_ATtiny13V_Clock_Current}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics{content/appendices/microprocessorPowerMeasurements/Graphs/Graph_ATtiny13V_Clock_Power}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics{content/appendices/microprocessorPowerMeasurements/Graphs/Graph_ATtiny13V_Clock_JPI}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics{content/appendices/microprocessorPowerMeasurements/Graphs/Graph_ATtiny25V_Clock_Power}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics{content/appendices/microprocessorPowerMeasurements/Graphs/Graph_ATtiny25V_Clock_JPI}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics{content/appendices/microprocessorPowerMeasurements/Graphs/Graph_PIC16F1827_Clock_Current}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics{content/appendices/microprocessorPowerMeasurements/Graphs/Graph_PIC16F1827_Clock_Power}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics{content/appendices/microprocessorPowerMeasurements/Graphs/Graph_PIC16F1827_Clock_JPI}
\par\end{centering}
...
\lstinputlisting[caption={ATtiny25V Sleep Proceedure},label={code:ATtiny25VSleepCode}]{content/appendices/microprocessorPowerMeasurements/Microcontrollers/ATtiny13V/Sleep.c}


\subsubsection{Clocking}

\lstinputlisting[caption={ATtiny25V Clocking Proceedure},label={code:ATtiny25VClockingCode}]{content/appendices/microprocessorPowerMeasurements/Microcontrollers/ATtiny13V/Clocking_old/Clocking.c}
...
\lstinputlisting[caption={16F1827 Sleep Proceedure - HI-TECH C version},label={code:PIC16F1827SleepCodeC}]{content/appendices/microprocessorPowerMeasurements/Microcontrollers/PIC16F1827/sleep.c}

\lstinputlisting[caption={16F1827 Sleep Proceedure - MPASM assembler version},label={code:PIC16F1827SleepCodeASM}]{content/appendices/microprocessorPowerMeasurements/Microcontrollers/PIC16F1827/sleep.asm}


\subsubsection{Clocking}

\lstinputlisting[caption={PIC16F1827 Clocking Proceedure},label={code:PIC16F1827ClockingCode}]{content/appendices/microprocessorPowerMeasurements/Microcontrollers/PIC16F1827/Clocking/MPLAB/main.c}
...
\lstinputlisting[caption={M9S08QG8 Clocking Proceedure},label={code:M9S08QG8ClockingCode}]{content/appendices/microprocessorPowerMeasurements/Microcontrollers/MC9S08QG8/sleep.c}
