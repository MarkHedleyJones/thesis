...
\section{The Scott-Single Interface Model}
  ...
  \subsection{The interface model}
    ...
    \subsubsection{Faradaic reactions: diodes}
      ...
      Exponential current draw with increasing voltage happens to be the transfer characteristic of a diode.
      For this reason, diodes are used in the model to mimic the current draw associated with Faradaic reactions.
      A diode also has the characteristic that it only conducts current in one direction.
