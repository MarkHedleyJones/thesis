...
\section{Methods Of Parameter Extraction}
  ...
  \subsection{Resistivity}
    ...
    A table of trans-impedance values is built up from these measurements where each row describes the current through a pair of driven electrodes and differential voltage measurements between a pair of non-driven electrodes.
    ...
    The first measurement configuration has electrodes one and eight being driven and every other pair combination being measured.
