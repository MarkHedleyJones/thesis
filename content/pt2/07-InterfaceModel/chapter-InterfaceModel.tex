...
\section{Methods Of Parameter Extraction}
  ...
  \subsection{Resistivity}
    ...
    This is because elements of the model can not be measured in isolation since the resistivity of the electrolyte solution will always be present in any measured data.
    ...
    Scott and Single measure the trans-impedances between pairs of electrodes in two different configurations where a defined AC current is driven between a pair of electrodes.
    ...
    For this method to work it is assumed that the current passing across each non-driven interface is zero, and therefore no voltage is dropped across that interface.
