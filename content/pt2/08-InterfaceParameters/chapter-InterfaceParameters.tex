...
\section{Phosphate Buffered Saline}
    ...
    \subsection{Faradaic Current}
      ...
      \subsubsection{Step based Faradaic measurements}
        ...
        \end{figure}
        Using the ``step and wait'' method to measure electrical currents associated with Faradaic conduction gave much improved results.
        \Cref{fig:graph_faradaic_currentVsTimeThesis,fig:graph_faradaic_currentVsVoltageThesis} show results using the 1.0X PBS solution; the other concentrations matched equally well.
        \Cref{fig:graph_faradaic_currentVsTimeThesis} shows that the simulated CPE does not follow the decay curve of the interface, evident at each transition.
        Notice again how the rate of decay appears to be dependant on the electrode overpotential, with higher voltages giving lower apparent capacitance.
        This suggests that in order for the simulated CPE to better represent the interface's displacement characteristics it should also be dependant on the electrode overpotential.
        No effort was made to incorporate the scaling of capacitance into the CPE of the model.
