...
%  \begin{figure}
%    \centering
%    \includegraphics{content/pt2/08-InterfaceParameters/graphics/graph_Sheep_Day1_Thesis}
%    \caption{\label{fig:graph_Sheep_Day1} Graph showing measured CPE impedance magnitude response from sheep one while alive and post-termination. No data was taken from these measurements for the purporse of fitting the CPE.}
%  \end{figure}
%  
%  \begin{figure}
%    \centering
%    \includegraphics{content/pt2/08-InterfaceParameters/graphics/graph_Sheep_Day2_Thesis}
%    \caption{\label{fig:graph_Sheep_Day2} Graph showing measured CPE impedance magnitude response from the spinal cavity of sheep two while alive and post-termination. The average value of each trace was used to fit parameter values.} 
%  \end{figure}
...
%  \Cref{fig:graph_Sheep_Day1,fig:graph_Sheep_Day2} show the measured CPE response on days one and two respectfully.

  % TODO: Rewrite these paragraphs to work with the updated graphs
  \Cref{fig:graph_Day2_sheep_CPE_ImpedanceMagnitude,fig:graph_Day2_Sheep_CPE_ImpedancePhase} shows the impedance magnitude and phase of the 
  Issues with reliability were encountered on the first day, evident in the spread of the data.
  Repeated measurement of a standard saline solution, made in the operating thearter between in-vivo measurements, indicates that part of the measurement system was misbehaving.
  Replacing the electrode array, rebuilding the measurement setup, and changing the location of the electrode insertion point solved the problem for the following days measurements.

  Day two's measurements, on the second sheep, give consistent results both before and post termination.
  ...
  The results indicate that there is practically no difference for at least thirty minutes after termination.
  Those measurements should have been carried out over a much longer duration after the sheep's termination to answer that question in a meaningful way.
