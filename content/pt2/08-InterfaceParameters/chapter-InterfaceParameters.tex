...
\section{Biological parameter measurements}
  ...
  This shows that the sheep spinal cavity provides a significant amount of reactance.
  ...
  Such situations only occur when the stimulus and measured electrodes are adjacent to one another and therefore the impedance was at its lowest.
  This means that the signal to noise ratio across the measured electrodes was very low, especially as the stimulus current was lowered to prevent triggering of any muscles.
