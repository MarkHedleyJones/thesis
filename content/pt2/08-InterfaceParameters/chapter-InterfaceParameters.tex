...
\section{Biological parameter measurements}
  ...
  The same electrode as was used in the previous measurements (St. Jude Medical Octrode) was inserted into the spinal cavity of the sheep for each experiment, as shown in \cref{fig:sheepSpine}.
  ...
  \subsection{Resistor Mesh}
  After insertion of the electrode array into the sheep, transimpedance measurements were made.
  ...
  \begin{figure}
    \centering
    \includegraphics{content/pt2/08-InterfaceParameters/graphics/sheep_transimpedance_doubleFit_mag}
  ...
  \begin{figure}
    \centering
    \includegraphics{content/pt2/08-InterfaceParameters/graphics/sheep_transimpedance_doubleFit_phase}
  ...
  An important result of these measurements is the phase response, as is shown in \cref{fig:sheep_transimpedance_doubleFit_phase}.
  Being non-zero shows that the spinal cavity provides 
