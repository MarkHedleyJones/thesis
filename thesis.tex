...
\chapter*{Abstract}
  ...
  My application for this is an energy harvester that could power electronic water meters.
  ...
  This work is important to designers of medical implants.
...
\part{Double Layers on Conductors: Electrical Impedance}
  ...
  In \cref{part:doubleLayersOnConductors} of this thesis I take that model and extend its predictive capability to a range of salinities.
...
\titleformat{\chapter}[block]
  ...
  \chapter{Other Biological Solution Attempts}
    \label{appendix:biologicalSolutions}
    \input{content/appendices/biologicalSolutions/biologicalSolutions.tex}
